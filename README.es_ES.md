...
[![](https://img.shields.io/github/v/release/kooroshmoradi/CYRUS-X.svg?style=for-the-badge)](https://github.com/kooroshmoradi/CYRUS-X/releases)
[![](https://img.shields.io/github/actions/workflow/status/kooroshmoradi/CYRUS-X/release.yml.svg?style=for-the-badge)](https://github.com/kooroshmoradi/CYRUS-X/actions)
[![GO Version](https://img.shields.io/github/go-mod/go-version/kooroshmoradi/CYRUS-X.svg?style=for-the-badge)](#)
[![Downloads](https://img.shields.io/github/downloads/kooroshmoradi/CYRUS-X/total.svg?style=for-the-badge)](https://github.com/kooroshmoradi/CYRUS-X/releases/latest)
...
```
bash <(curl -Ls https://raw.githubusercontent.com/kooroshmoradi/CYRUS-X/master/install.sh)
```

Para documentación completa, visita la [Wiki del proyecto](https://github.com/kooroshmoradi/CYRUS-X/wiki).
...
[![Stargazers over time](https://starchart.cc/kooroshmoradi/CYRUS-X.svg?variant=adaptive)](https://starchart.cc/kooroshmoradi/CYRUS-X) 
